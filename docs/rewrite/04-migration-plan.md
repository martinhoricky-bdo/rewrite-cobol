...
## R00 – Analýza a dokumentace (tento PR, Claude)
...
## R01 – Scaffolding projektu, Docker Compose, tooling (S–M)
...
## R03 – Seed vývojových dat z legacy souborů (M)
...
## R04 – Autentizace, role, kostra navigace (M)
...
## R06 – Sales: hledání letenek a detail letenky (M)
...
## R07 – Sales: tisk palubní vstupenky (S)
...
## R08 – Sales: cestující – seznam, detail, založení, editace (M)
...
## R10 – Sales: prodej – krok 2 a potvrzení (L)
...
## R11 – Sales: účtenka, detail nákupu, hromadný tisk (S–M)
...
## R13 – IT Support: účty, letiště, letadla (M)
...
## R15 – HR: zaměstnanci a oddělení (M)
...
## R16 – Schedule: lety, generování, posádky, směny (L → rozdělit na R16a lety+generování, R16b posádky+směny)
...
## R17 – Crew „my shifts“ a CEO dashboard (M)
