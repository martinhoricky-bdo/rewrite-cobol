...
FIXTURES = Path(__file__).parent / "fixtures/legacy_root"


def test_parse_employee_json_normalizes_legacy_types():
    rows = parse_employee_json(FIXTURES / "COB-PROG/EMPLO-INSERT/EMPLOYEE-LIST.json")
...
def test_parse_passenger_xml_preserves_utf8_and_trims_values():
    rows = parse_passenger_xml(FIXTURES / "COB-PROG/PASSENGER-INSERT/PASSENGER1.xml")
